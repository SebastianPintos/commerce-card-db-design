...
* _spObtenerDisponible()_ : Crea una _stored procedure_ que toma como parámetro un número de tarjeta y devuelve lo que el credito disponible de la tarjeta. Es decir, el monto total menos las compras aún no pagadas.
