...
* seguridadCompras(): Es la encargada de crear la funcion del trigger compras_lapso_tiempo. Esta funcion checkea que las compras en un lapso de tiempo para una tarjeta en diferentes comercios esten dentro del requerimiento solicitado.
* GenerarResumen(): 
- Carpeta no-sql: 
