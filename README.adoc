...
Como conclusión final, creemos que el trabajo realizado fue muy bueno. Consideramos que pudimos cumplir con todos los puntos planteados y nos complementamos bien como equipo a la hora de trabajar.
